...
　bltxt記法は、テキストをXMLのような階層関係がある構造（ [BLtxtクラス](/bltxt/groovydoc/io/github/longfish801/bltxt/BLtxt.html) のインスタンス）へ変換するための記法です。
...
　以下のタグを用いて XML化します。
　XML化には [BLtxtクラス](/bltxt/groovydoc/io/github/longfish801/bltxt/BLtxt.html) を利用してください。
